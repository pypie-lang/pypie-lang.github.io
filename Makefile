...
.PHONY: build compile-ts generate-learn-html generate-manual-html generate-installation-html generate-developer-notes-html deps clean

build: generate-learn-html generate-manual-html generate-installation-html generate-developer-notes-html compile-ts
