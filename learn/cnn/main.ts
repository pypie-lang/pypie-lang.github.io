        ...
        dialog: [
            {
                ...
                buildCodeBlock: (_ast: AstApi) => linearDefinitionBlock,
            },
            message(
                "W",
            ...
            ),
            {
                ...
                buildCodeBlock: (_ast: AstApi) => lenetPredictBlock,
                textAfterCode: "After `layer4`, we use !!`reshape`!! to flatten the rank-3 tensor to rank-1."
            },
            message(
                "W",
                "A model needs `predict`, `loss`, and `update`. " +
                "One down, two to go!"
            ),
            message(
                "D",
                "`loss` starts with the output of `predict`. " +
            ...
            ),
            {
                ...
                buildCodeBlock: (_ast: AstApi) => softmaxDefinitionBlock,
            ...
            ),
            {
                ...
                buildCodeBlock: (_ast: AstApi) => softmaxRunBlock,
            ...
            },
            {
                ...
                buildCodeBlock: (_ast: AstApi) => crossEntropyDefinitionBlock,
            },
            message(
                "W",
                "Then `softmax` turns predicted scores into probabilities.\n" +
            ...
            ),
            {
                ...
                buildCodeBlock: (_ast: AstApi) => crossEntropyRunBlock,
            ...
            },
            {
                ...
                buildCodeBlock: (_ast: AstApi) => lenetWithLrDefinitionBlock,
            ...
            ),
            {
                ...
                buildCodeBlock: (_ast: AstApi) => linearWithParamsDefinitionBlock,
            ...
            },
            {
                ...
                buildCodeBlock: (_ast: AstApi) => corr2dWithParamsDefinitionBlock,
            ...
            ),
            {
                ...
                buildCodeBlock: (_ast: AstApi) => lenetParamsDefinitionBlock,
