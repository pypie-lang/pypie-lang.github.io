(() => {
    ...
    render({
        ...
        dialog: [
            ...
            message("W", "The signal `s` and the pattern `p` are rank-1 tensors, but they have different shapes. " +
            ...
            {
                ...message("D", "Exactly. Now we have `corr2d`."),
            ...
            message("D", "Yes. We can specify dimensions for `sum`. Here, `sum` collapses the first dimension, `i`, producing the expected rank-2 tensor."),
            message("W", "That is very handy!"),
            {
                ...message("D", "Next, for multiple output channels, we use `corr2d_multi_in_out`."),
                codeLabel: "`corr2d_multi_in_out` definition",
                buildCodeBlock: (_ast) => corr2dMultiInOutDefinitionBlock,
            },
            message("W", "I see. Each input now corresponds to `o` patterns; each pattern has its own `bias`.\n" +
