(() => {
    ...
    render({
        ...
        dialog: [
            ...
            message("W", "How?"),
            message("D", "Machines use different formats to store `int` values and `float` values. They may " +
            ...
            message("D", "Fortunately, machines can do that reasoning for us, rigorously and efficiently.\n" +
            ...
            message("D", "By convention, values of `int` or `float` are called !!scalar!!s."),
